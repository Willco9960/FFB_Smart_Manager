...
Without ``--transactions`` this is an exact parity sweep for the current
projection/lineup CPU contract. With ``--transactions`` it compares outcomes
while explicitly labeling waiver/trade behavior as an experimental delta.
"""
