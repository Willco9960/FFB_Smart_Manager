...
from fantasy_engine.historical_player_pool import FANTASY_RELEVANT_POSITIONS
...
def create_weekly_performances(
    ...
    for row in rows:
        ...
        if position not in FANTASY_RELEVANT_POSITIONS or not week_text:
            continue
...
def load_weekly_performances(
    ...
    return create_weekly_performances(rows, scoring_settings)
